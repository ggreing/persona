...
SCHEMA_PATH = Path('C:/persona_ai_web/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\yunsh\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    def __init__(
        ...
        *,
        ...
        self.persona = actions.PersonaActions[models.Persona](self, models.Persona)
        ...
        self.chatanalysis = actions.ChatAnalysisActions[models.ChatAnalysis](self, models.ChatAnalysis)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/persona_ai_web/backend/prisma/schema.prisma',
        }
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ChatAnalysisBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
