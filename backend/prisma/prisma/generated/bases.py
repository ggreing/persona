...
class BasePersona(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Persona']] = 'Persona'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.PersonaActions[_PrismaModelT]':
        from .client import get_client

        return actions.PersonaActions[_PrismaModelT](client or get_client(), cls)
...
class BaseChatAnalysis(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ChatAnalysis']] = 'ChatAnalysis'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ChatAnalysisActions[_PrismaModelT]':
        from .client import get_client

        return actions.ChatAnalysisActions[_PrismaModelT](client or get_client(), cls)
